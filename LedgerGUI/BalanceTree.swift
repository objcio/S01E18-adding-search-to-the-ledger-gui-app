...
struct BalanceTreeNode: Tree, Equatable {
...
func ==(lhs: BalanceTreeNode, rhs: BalanceTreeNode) -> Bool {
    return lhs.amount == rhs.amount && lhs.children == rhs.children && lhs.path == rhs.path
}
